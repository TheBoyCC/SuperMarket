<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="receipt.aspx.cs" Inherits="PointSaleSystemWeb.manager.receipt" %>
                                                    ...
                                                    <div class="form-group receipt-content">
                                                        <div class="col-xs-10 col-xs-offset-1">
                                                            <table class="table table-condensed receipt-table">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="text-center table-header">Item</th>
                                                                        <th class="text-center table-header">Quantity</th>
                                                                        <th class="text-center table-header">Cost</th>
                                                                    </tr>
                                                                </thead>
